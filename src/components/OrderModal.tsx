...
const OrderModal = ({ isOpen, onClose, package: selectedPackage }) => {
  ...
  const sendEmail = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const emailParams = {
      ...
      packageName: selectedPackage ? selectedPackage.name : 'No package selected',
      packageDescription: selectedPackage ? selectedPackage.description : '',
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                {selectedPackage && (
                  <p className="text-gray-600">{selectedPackage.name} - ${selectedPackage.price}</p>
                )}
              </div>
            </div>
            <button
            ...
            <form onSubmit={sendEmail} className="space-y-6">
              ...
              {selectedPackage && (
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h3 className="font-semibold text-gray-900 mb-2">Selected Package: {selectedPackage.name}</h3>
